export default function MigrationVideoJsPage() {
  return (
    <article className="prose">
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            <td>HLS</td>
            <td>+hls.js ~93 kB</td>
            <td>+hls.js ~93 kB (shared)</td>
          </tr>
          <tr>
            <td>Quality plugin</td>
            <td>~8 kB</td>
            <td>0.28 kB</td>
          </tr>
          <tr>
            <td>Markers plugin</td>
            <td>~12 kB</td>
            <td>0.35 kB</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>React wrapper</td>
            <td>+react-video-js-player ~15 kB</td>
            <td>included</td>
          </tr>
        </tbody>
      </table>
      ...
      <h2>Cài đặt</h2>
      <pre>
        <code>{`# Gỡ video.js và các plugin
...
pnpm add @f8/player-plugin-keyboard @f8/player-plugin-hls-quality @f8/player-plugin-markers`}</code>
      ...
      <h2>Render cơ bản</h2>
      <p>
        <strong>Trước (video.js + React):</strong>
      </p>
      <pre>
    ...
    <div data-f8-player="" data-theme="classroom"
      ...
      <table>
        ...
        <tbody>
          <tr>
            <td>
              <code>videojs-hls-quality-selector</code> +{" "}
              <code>videojs-contrib-quality-levels</code>
            </td>
            <td>
              <code>createHlsQualityPlugin()</code> + <code>Controls.Quality</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>videojs-hotkeys</code>
            </td>
            <td>
              <code>createKeyboardPlugin()</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>videojs-markers</code>
            </td>
            <td>
              <code>createMarkersPlugin()</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>videojs-playbackrate-adjuster</code>
            </td>
            <td>
              <code>Controls.PlaybackRate</code> (built-in)
            </td>
          </tr>
          <tr>
            <td>
              <code>videojs-seek-buttons</code>
            </td>
            <td>
              dùng <code>usePlayer().seekTo()</code> với custom buttons
            </td>
          </tr>
          <tr>
            <td>
              <code>videojs-youtube</code>
            </td>
            <td>tự động — detect YouTube URL</td>
          </tr>
          <tr>
            <td>
              <code>videojs-contrib-eme</code>
            </td>
            <td>Phase 8 — DRM plugin (roadmap)</td>
          </tr>
        </tbody>
      </table>
...
// Runtime update:
player.command("markers:setMarkers", newMarkers);`}</code>
      </pre>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <code>usePlayer().pause()</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.currentTime(30)</code>
            </td>
            <td>
              <code>usePlayer().seekTo(30)</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.volume(0.5)</code>
            </td>
            <td>
              <code>usePlayer().setVolume(0.5)</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.muted(true)</code>
            </td>
            <td>
              <code>usePlayer().setMuted(true)</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.playbackRate(1.5)</code>
            </td>
            <td>
              <code>usePlayer().setPlaybackRate(1.5)</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.src({(src, type)})</code>
            </td>
            <td>
              <code>Root options.source.src = newSrc</code>
            </td>
          </tr>
          <tr>
            <td>
              <code>player.dispose()</code>
            </td>
            <td>tự động cleanup khi Root unmounts</td>
          </tr>
        </tbody>
      </table>
      ...
      <ul>
        <li>
          <input type="checkbox" readOnly /> Gỡ <code>video.js</code> và tất cả{" "}
          <code>videojs-*</code> plugins
        </li>
        <li>
        ...
        <li>
          <input type="checkbox" readOnly /> Thay <code>&lt;video className="video-js" /&gt;</code>{" "}
          bằng <code>&lt;Root&gt;&lt;Video /&gt;&lt;/Root&gt;</code>
        </li>
        <li>
          <input type="checkbox" readOnly /> Compose Controls layout (headless)
        </li>
        <li>
          <input type="checkbox" readOnly /> Migrate markers sang <code>createMarkersPlugin()</code>
        </li>
        <li>
          <input type="checkbox" readOnly /> Migrate keyboard sang{" "}
          <code>createKeyboardPlugin()</code>
        </li>
        <li>
          <input type="checkbox" readOnly /> Migrate quality selector sang{" "}
          <code>createHlsQualityPlugin()</code> + <code>Controls.Quality</code>
        </li>
        <li>
          <input type="checkbox" readOnly /> Xoá <code>player.dispose()</code> call thủ công (tự
          động)
        </li>
        <li>
          <input type="checkbox" readOnly /> Test tất cả use cases
        </li>
      </ul>
    </article>
  );
