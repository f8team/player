...
function WatermarkDemo({ position }: { position: "top-right" | "top-left" | "bottom-right" | "bottom-left" | "center" }) {
  const plugins = [
  ...
  return (
    <div style={{ width: "clamp(32rem, 80vw, 72rem)", aspectRatio: "16/9", position: "relative", background: "#000", borderRadius: "0.8rem", overflow: "hidden" }} data-f8-player="" data-theme="admin">
...
const meta: Meta<{ position: "top-right" | "top-left" | "bottom-right" | "bottom-left" | "center" }> = {
