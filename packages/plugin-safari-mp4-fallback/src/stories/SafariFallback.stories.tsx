...
function SafariFallbackDemo() {
  const plugins = [createSafariMp4FallbackPlugin({ resolveMp4: () => DEMO_MP4 })];
  ...
  return (
    <div>
      ...
      <p style={{ marginTop: "1.2rem", color: "#374151", fontSize: "1.3rem" }}>
        On desktop Safari or for uploaded MP4-type videos, the plugin swaps the HLS source for a
        direct MP4 URL, bypassing hls.js.
      </p>
    </div>
  );
}
